...
/**
 * Content scrim attribute type
 *
 * @author verstsiu created at 2020-12-07 11:32
 */
internal object ContentScrimAttrType : AttrType {
  override fun inject(view: View, resName: String, reader: ResourceReader): Boolean {
    ...
    view.setContentScrimResource(resId)
    return true
  }
}