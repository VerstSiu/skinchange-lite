...
/**
 * Collapsed title text appearance attribute type
 *
 * @author verstsiu created at 2020-12-07 11:53
 */
object CollapsedTitleTextAppearanceAttrType : AttrType {
  override fun inject(view: View, resName: String, reader: ResourceReader): Boolean {
    ...
    view.setCollapsedTitleTextAppearance(resId)
    return true
  }
}