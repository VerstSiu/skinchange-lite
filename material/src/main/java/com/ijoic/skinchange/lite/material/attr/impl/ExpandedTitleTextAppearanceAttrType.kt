...
/**
 * Expanded title text appearance attribute type
 *
 * @author verstsiu created at 2020-12-07 11:55
 */
object ExpandedTitleTextAppearanceAttrType : AttrType {
  override fun inject(view: View, resName: String, reader: ResourceReader): Boolean {
    ...
    view.setExpandedTitleTextAppearance(resId)
    return true
  }
}