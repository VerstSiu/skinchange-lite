...
/**
 * Close icon tint attribute type
 *
 * @author verstsiu created at 2020-12-07 22:14
 */
internal object CloseIconTintAttrType : AttrType {
  override fun inject(view: View, resName: String, reader: ResourceReader): Boolean {
    ...
    view.setCloseIconTintResource(resId)
    return true
  }
}