...
/**
 * Item text color attribute type
 *
 * @author verstsiu created at 2020-12-07 20:56
 */
internal object ItemRippleColorAttrType : AttrType {
  override fun inject(view: View, resName: String, reader: ResourceReader): Boolean {
    ...
    view.itemRippleColor = colorList
    return true
  }
}