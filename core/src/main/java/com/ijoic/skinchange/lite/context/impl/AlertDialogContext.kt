 ...
 * AlertDialog context
 *
 * @author verstsiu created at 2020-12-07 14:48
 */
object AlertDialogContext {
   ...
   */
  fun <T: AlertDialog> InjectContext<T>.injectIconAttribute(@AttrRes resId: Int): InjectContext<T> {
